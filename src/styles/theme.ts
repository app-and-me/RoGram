const theme = {
  Color: {
    Solid: {
      ...
      White: '#FFFFFF',
      Translucent: {
        Red: 'rgba(255, 64, 53, 0.1)',
        Orange: 'rgba(255, 154, 5, 0.1)',
        Yellow: 'rgba(245, 201, 5, 0.1)',
        Green: 'rgba(50, 204, 88, 0.1)',
        Blue: 'rgba(5, 127, 255, 0.1)',
        Indigo: 'rgba(91, 89, 222, 0.1)',
        Purple: 'rgba(183, 86, 232, 0.1)',
        Pink: 'rgba(255, 50, 90, 0.1)',
        Brown: 'rgba(167, 137, 99, 0.1)',
      },
    },
    Background: {
      Standard: {
